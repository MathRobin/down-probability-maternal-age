module.exports = (function () {
  ...
  function calculate (years, months) {
    ...
    const probability = Math.round(1 / (0.0005907 + Math.pow(2.71828182845905, (-5.182617 - monthsRounded * 0.6321469 + monthsRoundedPow2 * 0.0252150 - monthsRoundedPow3 * 0.0002285))));
    const result = {
